  ...
  return <section id="hero" className="relative min-h-screen flex items-center justify-center text-white overflow-hidden" style={{
    ...
    backgroundAttachment: 'fixed'
      ...
      <div className="container mx-auto px-4 text-center relative z-10 max-w-6xl">
        ...
        <h2 className="text-6xl md:text-8xl font-montserrat font-bold mb-8 tracking-tight bg-gradient-to-r from-blue-400 via-cyan-300 to-green-400 bg-clip-text text-transparent animate-fade-in">
          Media Production
        </h2>
