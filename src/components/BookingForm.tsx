...
const BookingForm = () => {
  ...
  const packages = [{
    ...
    name: "Standard Package - $60,000",
    price: 60000
  }, {
    name: "Premium Package - $110,000",
    price: 110000
  }, {
    name: "Elite Videography Package - $400,000",
    price: 400000
  }];
  const addOnItems = [{
    name: "Complimentary Pre-event Consultation",
    price: 0,
    maxQty: 1
  }, {
    name: "Additional Cameraman",
    price: 25000
  }, {
    name: "Additional Technician",
    price: 20000
  }, {
    ...
    name: "Remote Speaker Integration",
    price: 5000
  }, {
    name: "Event DJ",
    price: 50000
    ...
    name: "Highlight Video/Story",
    price: 60000
  }, {
    name: "Same-Day Edited Highlight Video",
    price: 80000
  }, {
    name: "Same-Day Highlight Reel",
    price: 25000
  }, {
    name: "Personalized Video Tribute",
    price: 50000
  }, {
    name: "Drone Video/Photo",
    price: 30000
  }, {
    name: "Basic Event Photography",
    price: 25000
  }, {
    name: "Full Event Photography",
    price: 50000
  }, {
    name: "Photo Slideshow with Music",
    price: 10000
  }, {
    name: "Projector + 100\" Screen Setup",
    price: 35000
  }, {
    name: "55\" TV Setup",
    price: 35000
    ...
    name: "Stage Lighting (Advanced)",
    price: 185000
  }, {
    name: "Generator (7000 W)",
    price: 50000
  }, {
    name: "Towable Diesel Generator (20,000 W)",
    price: 90000
  }, {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <form action="https://formspree.io/f/xzzgejrb" method="POST" onSubmit={handleFormSubmit} className="space-y-8 animate-slide-left">
              ...
              <div>
                ...
                <Textarea id="additional-details" name="additional_details" placeholder="Tell us about any specific requirements for your event..." rows={4} />
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                {selectedPackage && <div className="flex justify-between mb-2">
                    <span>Package:</span>
                ...
                return <div key={name} className="flex justify-between mb-2">
              ...
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 text-lg font-semibold transition-all duration-300 hover:scale-105">Request a Booking </Button>
